        ...
        protected File doInBackground(Void... voids) {
            ...
            try {
                ...
                if (urls.getProtocol().toLowerCase().equals("https")) {
                    HttpsURLConnection https = (HttpsURLConnection)urls.openConnection();
                    https.setHostnameVerifier(SSLSocketFactoryUtils.createTrustAllHostnameVerifier());
                    connect = https;
                } else {
                    connect = (HttpURLConnection)urls.openConnection();
                }
